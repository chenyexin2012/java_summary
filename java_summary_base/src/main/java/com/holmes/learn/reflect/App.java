package com.holmes.learn.reflect;
...
public class App {
    ...
    public void test2() {
        ...
        System.out.println("获取Student的所有共有构造方法以及参数");
        ...
        try {
            System.out.println("获取私有无参的构造方法");
    ...
    public void test4() throws Exception {
        ...
        Class clazz = MyObject.class;
        System.out.println("获取MyObject所有的共有字段。。。");
    ...
    public void test5() throws Exception {
        ...
        System.out.println("******************获取MyClass共有方法******************");
        ...
        System.out.println("******************调用MyClass的共有方法******************");
